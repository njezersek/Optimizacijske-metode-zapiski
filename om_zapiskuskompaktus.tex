...
\begin{align*}
	L_{x_i} &= 0 & \forall i = 1, \dots, n \\
	\lambda_j g_j &= 0 & \forall j = 1, \dots, m \\
	g_j &\leq 0 & \forall j = 1, \dots, m \\
	\lambda_j &\geq 0 & \forall j = 1, \dots, m \\
\end{align*}
\emph{V splošnem KKT pogoji niso ne potrebni ne zadostni za globalni/lokalni ekstrem.}

\begin{itemize}
	\item $\Omega$ odprta, konveksna množica, $f, g_1, \dots, g_m : \Omega \to \mathbb{R}$ konveksna, odvedljiva \\
			Če $x^*$ ustreza KKT pogojem, je globalni minimum.
	\item $\Omega$ odprta, $f: \Omega \to \mathbb{R}$ odvedljiva, $g_1, \dots, g_m: \Omega \to \mathbb{R}$.\\
			Če velja vsaj ena izmed trditev:
			\begin{itemize}
